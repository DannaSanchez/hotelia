                ...
                <div className="formhuesped-background">
                    ...
                    <formulario  action="">
                        ...
                        <div>
                            ...
                            <div><input className="formhuesped-radio" type= "radio" name="sexo"/>femenino</div> 
                        ...
                        <div>
                            ...
                            <div >
                            <input
                               className="formhuesped-image" type="file" name="file" accept=".jpg,.png"
                            />
                            </div>
                        </div>
                        <div>
                        ...
                        <div className="formhuesped-condiciones">
                            ...
                            <label className="mb-2" for="condiciones">Acepta los  <a onClick={handleShow}>  Terminos y Condiciones </a></label>
                                ...
                                <Modal className="formhuesped-modal" show={show} onHide={handleClose}>
                                    ...
                                    <Modal.Footer>
                                    <Button  className="formhuesped-modal-button m-auto" variant="secondary" onClick={handleClose}>
                                        De acuerdo
                                    </Button>
                                    </Modal.Footer>
                                </Modal>
